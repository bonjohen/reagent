...
class TestResearchManager:
    ...
    def test_init(self, mock_console):
        ...
        # Create a manager
        with patch('research_agent.manager.Printer') as mock_printer_class, \
             patch('research_agent.manager.ResearchPersistence') as mock_persistence_class:
    ...
    async def test_run_new_session(self, mock_console, mock_runner):
        ...
        with patch('research_agent.manager.Printer') as mock_printer_class, \
             patch('research_agent.manager.ResearchPersistence') as mock_persistence_class, \
             patch('research_agent.manager.gen_trace_id', return_value="test_trace_id"), \
             patch('research_agent.manager.trace'):
    ...
    async def test_plan_searches(self, mock_console, mock_runner):
        ...
        with patch('research_agent.manager.Printer') as mock_printer_class, \
             patch('research_agent.manager.ResearchPersistence') as mock_persistence_class, \
             patch('research_agent.manager.planner_agent') as mock_planner_agent:
    ...
    async def test_search(self, mock_console, mock_runner):
        ...
        with patch('research_agent.manager.Printer') as mock_printer_class, \
             patch('research_agent.manager.ResearchPersistence') as mock_persistence_class, \
             patch('research_agent.manager.search_agent') as mock_search_agent:
    ...
    async def test_search_with_timeout(self, mock_console):
        ...
        with patch('research_agent.manager.Printer') as mock_printer_class, \
             patch('research_agent.manager.ResearchPersistence') as mock_persistence_class, \
             patch('research_agent.manager.search_agent') as mock_search_agent, \
             patch('research_agent.manager.Runner.run', new_callable=AsyncMock) as mock_run:
    ...
    async def test_write_report(self, mock_console, mock_runner):
        ...
        with patch('research_agent.manager.Printer') as mock_printer_class, \
             patch('research_agent.manager.ResearchPersistence') as mock_persistence_class, \
             patch('research_agent.manager.writer_agent') as mock_writer_agent:
